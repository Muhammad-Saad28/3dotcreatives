      ...
      <div className="flex items-center justify-between h-[82px] max-w-7xl mx-auto w-full px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-5">
          <div className="flex items-center gap-3 mr-2">
            <Link
              href="https://wa.me/923052288882"
              target="_blank"
              rel="noopener noreferrer"
              className="text-cream/70 hover:text-cream transition-colors hover:scale-110"
              aria-label="WhatsApp"
            >
            ...
            <Link
              href="https://www.instagram.com/3dotcreativesagency"
              target="_blank"
              rel="noopener noreferrer"
              className="text-cream/70 hover:text-cream transition-colors hover:scale-110"
